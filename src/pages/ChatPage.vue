<template>
  <div class="h-full flex">
    ...
    <div class="flex-1 flex flex-col">
      <header class="px-4 py-3 border-b border-bg-border bg-bg-secondary flex items-center justify-between">
    ...
    <aside class="w-64 bg-bg-secondary p-3 border-l border-bg-border">
